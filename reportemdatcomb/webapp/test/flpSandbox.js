		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Reporte Mod. Datos Combustible",
									"targetURL": "#ReporteModDatosCombustible-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ReporteModDatosCombustible-display": {
								"semanticObject": "ReporteModDatosCombustible",
								"action": "display",
								"description": "App de control logístico",
								"title": "Reporte Mod. Datos Combustible",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.tasa.reportemdatcomb",
									"url": sap.ui.require.toUrl("com/tasa/reportemdatcomb")
								}
							}
						}
					}
