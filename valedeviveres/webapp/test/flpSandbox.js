					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "valedeviveres",
									"targetURL": "#valedeviveres-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"valedeviveres-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=tasa.com.valedeviveres",
									"url": sap.ui.require.toUrl("tasa/com/valedeviveres")
								}
							}
						}
					}
