		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#AnálisisdeCombustible-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"AnálisisdeCombustible-display": {
								"semanticObject": "AnálisisdeCombustible",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.tasa.analisiscomb",
									"url": sap.ui.require.toUrl("com/tasa/analisiscomb")
								}
							}
						}
					}
