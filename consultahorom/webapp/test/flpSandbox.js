		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Consulta Horómetros",
									"targetURL": "#ConsultaHorómetros-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ConsultaHorómetros-display": {
								"semanticObject": "ConsultaHorómetros",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.tasa.consultahorom",
									"url": sap.ui.require.toUrl("com/tasa/consultahorom")
								}
							}
						}
					}
