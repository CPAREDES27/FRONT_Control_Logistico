		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#Aceitesusados-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"Aceitesusados-display": {
								"semanticObject": "Aceitesusados",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.tasa.aceitesusados",
									"url": sap.ui.require.toUrl("com/tasa/aceitesusados")
								}
							}
						}
					}
