		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#ValedeVíveres-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ValedeVíveres-display": {
								"semanticObject": "ValedeVíveres",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.tasa.valeviveres",
									"url": sap.ui.require.toUrl("com/tasa/valeviveres")
								}
							}
						}
					}
