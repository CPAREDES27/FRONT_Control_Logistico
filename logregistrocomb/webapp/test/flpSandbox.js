		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Log Registro Combustible",
									"targetURL": "#LogRegistroCombustible-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"LogRegistroCombustible-display": {
								"semanticObject": "LogRegistroCombustible",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.tasa.logregistrocomb",
									"url": sap.ui.require.toUrl("com/tasa/logregistrocomb")
								}
							}
						}
					}
