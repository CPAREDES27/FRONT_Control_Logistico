		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "analisisdecombustible",
									"targetURL": "#analisisdecombustible-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"analisisdecombustible-display": {
								"semanticObject": "analisisdecombustible",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=tasa.com.analisisdecombustible",
									"url": sap.ui.require.toUrl("tasa/com/analisisdecombustible")
								}
							}
						}
					}
